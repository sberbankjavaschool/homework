...
class MyScalableConcurrentThreadPoolTest {
    private MyScalableConcurrentThreadPool pool;

    private void fillScalablePool() {
        pool = new MyScalableConcurrentThreadPool(4, 10);
    }

    private void fillFixedPool() {
        pool = new MyScalableConcurrentThreadPool(2);
    }
    ...
    void deleteThreads() {
        pool = new MyScalableConcurrentThreadPool(1, 10);
        fillTasks();
        pool.start();
        try {
            Thread.sleep(300);
