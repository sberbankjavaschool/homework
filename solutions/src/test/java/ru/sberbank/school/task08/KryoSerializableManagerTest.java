...
public class KryoSerializableManagerTest {
    private Savable mapState;
    private KryoSerializableManager manager;
    private String path;
    private String fileName;

    public KryoSerializableManagerTest () {
    ...
    public void initialize () {
        manager = new KryoSerializableManager(path);
        manager.initialize();
