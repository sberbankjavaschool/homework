...
###Задание:
**Часть 1 (id 1):** Реализовать валютный калькулятор (ВК). **(делаем вот это)**

**Часть 2 (id 2):** в дополение к ВК реализовать обратный валютный калькулятор. 

**Часть 3\* (id 3):** реализовать расчет кросс-курсов.
