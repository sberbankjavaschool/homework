...
###Задание:
**Часть 1 (id 2):** Реализовать валютный калькулятор (ВК). **(делаем вот это)**

**Часть 2 (id 3):** в дополение к ВК реализовать обратный валютный калькулятор. 

**Часть 3\* (id 4):** реализовать расчет кросс-курсов.
